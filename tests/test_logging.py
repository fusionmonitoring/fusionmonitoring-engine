...
"""
Test fusionsupervision.logging
"""
...
from fusionsupervision.log import setup_logger, set_log_level, set_log_console, ALIGNAK_LOGGER_NAME

from .fusionsupervision_test import FusionsupervisionTest, CollectorHandler


class TestLogging(FusionsupervisionTest):

    def setUp(self):
        super(TestLogging, self).setUp()

        # By default get fusionsupervision logger and setup to Info level and add collector
...
class TestLogging2(FusionsupervisionTest):
    ...
    def test_set_console(self):
        ...
        logger_configuration_file = os.path.join(os.getcwd(),
                                                 './etc/no_console_fusionsupervision-logger.json')
        print("Logger configuration file: %s" % logger_configuration_file)
        self._set_console_log(logger_configuration_file)
