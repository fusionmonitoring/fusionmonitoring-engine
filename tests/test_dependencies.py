...
class TestDependencies(FusionsupervisionTest):
    """
    ...
    * test_*_h_*: test with hostgroups
    ...
    def test_c_dependencies(self):
        ...
        # '/home/fusionsupervision/fusionsupervision/test/cfg/default/servicegroups.cfg:48' and
        # '/home/fusionsupervision/fusionsupervision/test/cfg/default/servicegroups.cfg:48', using lastly defined.
