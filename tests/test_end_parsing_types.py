...
from fusionsupervision.property import UnusedProp, StringProp, IntegerProp, \
...
from fusionsupervision.objects.item import Items

logger = logging.getLogger(__name__)

class TestEndParsingType(FusionsupervisionTest):
    """
    ...
    def check_objects_from(self, container):
        """ Check properties of an fusionsupervision item

        :param container: object / fusionsupervision item
