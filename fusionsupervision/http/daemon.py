...
"""
This module provide the HTTP daemon for FusionSupervision Engine inter daemon communication.
...
from fusionsupervision.http.cherrypy_extend import zlib_processor
...
class HTTPDaemon(object):
    ...
    def __init__(self, host, port, http_interface, use_ssl, ca_cert,
        ...
        # Mount the main application (an FusionSupervision Engine daemon interface)
