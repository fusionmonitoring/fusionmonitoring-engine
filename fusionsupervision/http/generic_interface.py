...
Any FusionSupervision Engine satellite have at least these functions exposed over network
...
class GenericInterface(object):
    ...
    def identity(self):
        ...
        - fusionsupervision: the FusionSupervision Engine instance name
        - version: the FusionSupervision Engine version
    ...
    def get_log_level(self):
        ...
        fusionsupervision_logger = logging.getLogger(ALIGNAK_LOGGER_NAME)

        res = self.identity()
        res.update({"log_level": fusionsupervision_logger.getEffectiveLevel(),
                    "log_level_name": level_names[fusionsupervision_logger.getEffectiveLevel()]})
        return res
    ...
    def set_log_level(self, log_level=None):
        ...
        fusionsupervision_logger = logging.getLogger(ALIGNAK_LOGGER_NAME)
        fusionsupervision_logger.setLevel(log_level)
    ...
    def stats(self, details=False):
        ...
        - program_start: the FusionSupervision Engine start timestamp
