...
"""This module provide Daterange and Timerange classes used to create Timeperiod in FusionSupervision Engine
"""
import time
import calendar
import logging
...
class Timerange(FusionsupervisionObject):
...
class AbstractDaterange(FusionsupervisionObject):
