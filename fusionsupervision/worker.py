...
from fusionsupervision.action import ACT_STATUS_QUEUED, ACT_STATUS_LAUNCHED, \
    ACT_STATUS_DONE, ACT_STATUS_TIMEOUT
from fusionsupervision.action import ActionError
...
class Worker(object):  # pylint: disable=too-many-instance-attributes
    ...
    def get_new_checks(self, queue, return_queue):
        ...
        REF: doc/fusionsupervision-action-queues.png (3)
    ...
    def launch_new_checks(self):
        ...
        REF: doc/fusionsupervision-action-queues.png (4)
    ...
    def manage_finished_checks(self, queue):
        ...
        REF: doc/fusionsupervision-action-queues.png (5)
    ...
    def do_work(self, actions_queue, returns_queue, control_queue=None):  # pragma: no cover
        ...
        * Manage finished checks
        ...
        setproctitle("fusionsupervision-%s worker %s" % (self.loaded_into, self._id))
