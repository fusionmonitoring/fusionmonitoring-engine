...
"""
This module group the FusionSupervision Engine self monitoring features.

Currently, it contains an FusionSupervision Engine Web Service client used to report FusionSupervision Engine status
...
class MonitorConnection(object):
    """Base class for FusionSupervision Engine Web Services client connection"""
    ...
    def __init__(self, endpoint='http://127.0.0.1:7773/ws'):
        ...
        logger.info("FusionSupervision Engine monitor, endpoint: %s", self.url_endpoint_root)
    ...
    def get(self, endpoint, params=None):
        """
        Get items or item in fusionsupervision backend
