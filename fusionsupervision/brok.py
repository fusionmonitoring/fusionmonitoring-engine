...
"""Brok module provide Brok class which is basically event for FusionSupervision Engine.
...
class Brok(object):
    """A Brok is a piece of information exported by FusionSupervision Engine to the Broker.
