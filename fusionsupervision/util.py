...
def to_hostnames_list(ref, tab):  # pragma: no cover, to be deprecated?
    ...
    :type ref:
    :param tab: Host list
    :type tab: list[fusionsupervision.objects.host.Host]
...
def parse_daemon_args(arbiter=False):
    ...
    All daemons:
        ...
        This allows an arbiter to find its own configuration in the whole FusionSupervision Engine configuration
        ...
        '-e', '--environment': FusionSupervision Engine environment file - the most important and mandatory
        parameter to define the name of the fusionsupervision.ini configuration file
        ...
        These parameters allow to override the one defined in the FusionSupervision Engine configuration file:
    ...
    :return: args
    """
    parser = argparse.ArgumentParser(description="FusionSupervision Engine version %s daemon parameters" % VERSION,
    ...
    if arbiter:
        parser.add_argument('-a', '--arbiter', action='append',
                            ...
                            help='Legacy configuration file(s). '
                                 ...
                                 'the Nagios-like objects files in the fusionsupervision-configuration '
        ...
        parser.add_argument('-k', '--fusionsupervision-name', dest='fusionsupervision_name',
                            default='My FusionSupervision ',
                            help='Set the name of the FusionSupervision Engine instance. If not set, the arbiter '
                                 'name will be used in place. Note that if an fusionsupervision_name '
    ...
    parser.add_argument('-e', '--environment', dest='env_file', required=True,
                        default='../../etc/fusionsupervision.ini',
                        help='FusionSupervision Engine global environment file. '
                             'This file defines all the daemons of this FusionSupervision Engine '
