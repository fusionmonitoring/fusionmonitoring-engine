...
from fusionsupervision.property import BoolProp, IntegerProp, StringProp
...
class Downtime(FusionsupervisionObject):
    ...
    properties = {
        ...
        'author':
            StringProp(default=u'FusionSupervision Engine', fill_brok=['full_status']),
        'comment':
            StringProp(default=u''),
        'is_in_effect':
    ...
    def enter(self, timeperiods, hosts, services):
        ...
        if item.scheduled_downtime_depth == 1:
            ...
            if self.ref in hosts:
                ...
                item.acknowledge_problem(notification_period, hosts, services, 2, 1, "FusionSupervision Engine",
