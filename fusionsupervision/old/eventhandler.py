...
from fusionsupervision.action import Action
from fusionsupervision.property import StringProp, BoolProp
...
class EventHandler(Action):
    ...
    def get_return_from(self, e_handler):
        ...
        * perf_data
        ...
        :type e_handler: fusionsupervision.eventhandler.EventHandler
        :return: None
        """
