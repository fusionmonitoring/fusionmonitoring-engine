...
from fusionsupervision.property import BoolProp, IntegerProp, ListProp
from fusionsupervision.brok import Brok
from fusionsupervision.external_command import ExternalCommand

from fusionsupervision.action import ACT_STATUS_QUEUED
...
from fusionsupervision.check import Check  # pylint: disable=W0611
from fusionsupervision.objects.module import Module  # pylint: disable=W0611
from fusionsupervision.objects.satellitelink import SatelliteLink, LinkError
...
class BaseSatellite(Daemon):
    ...
    Sub-classed by FusionSupervision Engine (scheduler), Broker and Satellite
    ...
    def setup_new_conf(self):
        ...
        This function is the generic treatment needed for every FusionSupervision Engine daemon when it receivss
