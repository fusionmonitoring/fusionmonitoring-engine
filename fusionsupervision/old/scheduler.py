...
from fusionsupervision.action import ACT_STATUS_SCHEDULED, ACT_STATUS_POLLED, \
...
from fusionsupervision.util import average_percentile
...
class Scheduler(object):  # pylint: disable=R0902
    ...
    def __init__(self, scheduler_daemon):
        ...
        :type scheduler_daemon: fusionsupervision.daemons.schedulerdaemon.Fusionsupervision
        """
        ...
        self.fusionsupervision_name = None
    ...
    def load_conf(self, instance_id, instance_name, conf):
        ...
        :type conf: fusionsupervision.objects.config.Config
        :return: None
        """
        ...
        self.fusionsupervision_name = self.pushed_conf.fusionsupervision_name
    ...
    def update_recurrent_works_tick(self, conf):
        ...
        a tick value to be updated. Those parameters are defined in the fusionsupervision environment file.
        ...
        :type conf: fusionsupervision.daemons.schedulerdaemon.Fusionsupervision
        :return: None
        """
    ...
    def add_brok(self, brok, broker_uuid=None):
        ...
        :type brok: fusionsupervision.brok.Brok
    ...
    def add_event_handler(self, action):
        ...
        :type action: fusionsupervision.eventhandler.EventHandler
        :return: None
        """
    ...
    def add_external_command(self, ext_cmd):
        ...
        :type ext_cmd: fusionsupervision.external_command.ExternalCommand
        :return: None
        """
    ...
    def get_and_register_check_result_brok(self, item):
        ...
        :param item: item to get brok from
        :type item: fusionsupervision.objects.schedulingitem.SchedulingItem
        :return: None
        """
    ...
    def get_to_run_checks(self, do_checks=False, do_actions=False,
        ...
        if do_checks:
            ...
            for check in list(self.checks.values()):
                ...
                if check.internal:
                    # Do not care about FusionSupervision Engine internally executed checks
                    continue
    ...
    def get_retention_data(self):  # pylint: disable=too-many-branches,too-many-statements
        ...
        todo: FusionSupervision Engine scheduler creates two separate dictionaries: hosts and services
    ...
    def restore_retention_data_item(self, data, item):
        ...
        :type item: fusionsupervision.objects.host.Host | fusionsupervision.objects.service.Service
        :return: None
        """
    ...
    def get_program_status_brok(self, brok_type='program_status'):
        ...
        data = {
            ...
            # "fusionsupervision_name": self.fusionsupervision_name,
            ...
            if elt.in_maintenance == -1:
                ...
                if timeperiod.is_time_valid(now):
                    ...
                    data = {
                        ...
                        'duration': 0, 'author': "FusionSupervision Engine",
                        'comment': "This downtime was automatically scheduled by FusionSupervision Engine "
    ...
    def find_item_by_id(self, object_id):
        ...
        :return:
        :rtype: fusionsupervision.objects.item.Item | None
        """
