...
that fusionsupervision modules will subclass
"""
...
class BaseModule(object):
    ...
    """This is the base class for the FusionSupervision Engine modules.
    Modules can be used by the different FusionSupervision Engine daemons for different tasks.
    Example of task that an FusionSupervision Engine module can do:
    ...
    def init(self):  # pylint: disable=no-self-use
        ...
        This function must be present and return True for FusionSupervision Engine to consider the module as loaded
    ...
    def create_queues(self, manager=None):
        """
        Create the shared queues that will be used by fusionsupervision daemon
    ...
    def want_brok(self, b):  # pylint: disable=unused-argument,no-self-use
        ...
        :type b: fusionsupervision.brok.Brok
    ...
    def set_proctitle(self, name):
        ...
        :return: None
        """
        setproctitle("fusionsupervision-%s module: %s" % (self.loaded_into, name))
