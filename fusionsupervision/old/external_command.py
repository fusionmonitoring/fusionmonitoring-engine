...
# This import, despite not used, is necessary to include all FusionSupervision Engine objects modules
# pylint: disable=wildcard-import,unused-wildcard-import
from fusionsupervision.action import ACT_STATUS_DONE, ACT_STATUS_TIMEOUT, ACT_STATUS_WAIT_CONSUME
from fusionsupervision.objects import *
from fusionsupervision.util import to_int, to_bool, split_semicolon
...
from fusionsupervision.log import make_monitoring_log
...
class ExternalCommandManager(object):
    """ExternalCommandManager manages all external commands sent to FusionSupervision Engine.
    ...
    def __init__(self, conf, mode, daemon, accept_unknown=False, log_external_commands=False):
        ...
        :type conf: fusionsupervision.objects.Config
        :param mode: command manager mode
        :type mode: str
        :param daemon:
        :type daemon: fusionsupervision.Daemon
    ...
    def send_an_element(self, element):
        ...
        :type: fusionsupervision.Brok, or Comment, or Downtime, ...
        :return:
        """
    ...
    def resolve_command(self, excmd):
        ...
        :type excmd: fusionsupervision.external_command.ExternalCommand
    ...
    def search_host_and_dispatch(self, host_name, command, extcmd):
        ...
        :type extcmd: fusionsupervision.external_command.ExternalCommand
        :return: None
        """
    ...
    def get_unknown_check_result_brok(cmd_line):
        ...
        :rtype: fusionsupervision.objects.brok.Brok
        """
        match = re.match(
    ...
    def get_command_and_args(self, command, extcmd=None):
        ...
        # Look if the command is purely internal (FusionSupervision Engine) or not
        internal = False
    ...
    def change_contact_modsattr(contact, value):
        ...
        :type contact: fusionsupervision.objects.contact.Contact
    ...
    def change_contact_host_notification_timeperiod(self, contact, notification_timeperiod):
        ...
        :type notification_timeperiod: fusionsupervision.objects.timeperiod.Timeperiod
        :return: None
        """
        # todo: deprecate this
    ...
    def add_svc_comment(self, service, author, comment):
        ...
        :type service: fusionsupervision.objects.service.Service
    ...
    def add_host_comment(self, host, author, comment):
        ...
        :type host: fusionsupervision.objects.host.Host
        :param author: author name
        :type author: str
        :param comment: text comment
        :type comment: str
    ...
    def change_global_host_event_handler(self, event_handler_command):
        ...
        logger.warning("The external command 'CHANGE_GLOBAL_HOST_EVENT_HANDLER' "
                       "is not currently implemented in FusionSupervision Engine. If you really need it, "
                       "request for its implementation in the project repository: "
                       "https://github.com/fusionsupervision/fusionsupervision-engine")
        self.send_an_element(make_monitoring_log(
    ...
    def change_host_check_timeperiod(self, host, timeperiod):
        ...
        :type timeperiod: fusionsupervision.objects.timeperiod.Timeperiod
        :return: None
        """
    ...
    def change_svc_check_timeperiod(self, service, check_timeperiod):
        ...
        :type check_timeperiod: fusionsupervision.objects.timeperiod.Timeperiod
        :return: None
        """
    ...
    def disable_contactgroup_host_notifications(self, contactgroup):
        ...
        :type contactgroup: fusionsupervision.objects.contactgroup.Contactgroup
        :return: None
        """
    ...
    def disable_hostgroup_host_checks(self, hostgroup):
        ...
        :type hostgroup: fusionsupervision.objects.hostgroup.Hostgroup
        :return: None
        """
    ...
    def disable_servicegroup_host_checks(self, servicegroup):
        ...
        :type servicegroup: fusionsupervision.objects.servicegroup.Servicegroup
        :return: None
        """
    ...
    def restart_program(self):
        """Restart FusionSupervision Engine
        Format of the line that triggers function call::
        ...
        :return: None
        """
        restart_cmd = self.commands.find_by_name('restart-fusionsupervision')
        if not restart_cmd:
            logger.error("Cannot restart FusionSupervision Engine : missing command named"
                         " 'restart-fusionsupervision'. Please add one")
            return
        ...
        if e_handler.status == ACT_STATUS_TIMEOUT or e_handler.exit_status != 0:
            logger.error("Cannot restart FusionSupervision Engine : the 'restart-fusionsupervision' command failed with"
    ...
    def reload_config(self):
        """Reload FusionSupervision Engine configuration
        Format of the line that triggers function call::
        ...
        :return: None
        """
        reload_cmd = self.commands.find_by_name('reload-fusionsupervision')
        if not reload_cmd:
            logger.error("Cannot restart FusionSupervision Engine : missing command"
                         " named 'reload-fusionsupervision'. Please add one")
            return
        ...
        log_level = 'info'
        if e_handler.status == ACT_STATUS_TIMEOUT or e_handler.exit_status != 0:
            logger.error("Cannot reload FusionSupervision Engine configuration: the 'reload-fusionsupervision' command failed"
    ...
    def schedule_forced_host_check(self, host, check_time):
        ...
        :type host: fusionsupervision.object.host.Host
    ...
    def schedule_forced_svc_check(self, service, check_time):
        ...
        :type service: fusionsupervision.object.service.Service
        :param check_time: time to check
        :type check_time: int
        :return: None
        """
    ...
    def schedule_servicegroup_host_downtime(self, servicegroup, start_time, end_time,
        ...
        :type servicegroup: fusionsupervision.object.servicegroup.Servicegroup
        :param start_time: downtime start time
        :type start_time:
        :param end_time: downtime end time
        :type end_time:
    ...
    def shutdown_program(self):
        """DOES NOTHING (Should shutdown FusionSupervision Engine)
        Format of the line that triggers function call::
