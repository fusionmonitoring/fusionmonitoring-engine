...
from fusionsupervision.property import StringProp, BoolProp, IntegerProp, ListProp
...
class CommandCall(FusionsupervisionObject):
    ...
    def __init__(self, params, parsing=False):
        ...
        if 'commands' not in params:
            ...
            # Link the provided FusionSupervision Engine command with myself
