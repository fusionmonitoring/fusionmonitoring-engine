...
from fusionsupervision.property import ListProp
...
class Itemgroup(Item):
    ...
    def copy_shell(self):
        ...
        :rtype: fusionsupervision.objects.itemgroup.Itemgroup
        :return: None
        """
        cls = self.__class__
    ...
    def get_initial_status_brok(self, extra=None):
        ...
        :type extra: fusionsupervision.objects.item.Items
        :return:Brok object
        :rtype: object
        """
...
class Itemgroups(Items):
    ...
    def add(self, itemgroup):
        ...
        :type itemgroup: fusionsupervision.objects.itemgroup.Itemgroup
        :return: None
        """
