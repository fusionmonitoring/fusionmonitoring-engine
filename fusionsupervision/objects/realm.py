...
implements realm for FusionSupervision Engine. Basically used for parsing.
"""

import copy
import logging
from fusionsupervision.objects.itemgroup import Itemgroup, Itemgroups
from fusionsupervision.property import BoolProp, StringProp, DictProp, ListProp, IntegerProp
...
class Realms(Itemgroups):
    ...
    def get_default(self, check=False):
        ...
        :type check: bool
        :return: Default realm of FusionSupervision Engine configuration
        :rtype: fusionsupervision.objects.realm.Realm | None
        """
        found = []
    ...
    def prepare_satellites(self, satellites):
        ...
        * self.potential_*satellite type*s
        ...
        :type satellites: fusionsupervision.object.satelittelink.SatelliteLink
        :return: None
        """
        for realm in self:
