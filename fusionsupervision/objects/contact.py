...
from fusionsupervision.util import strip_and_uniq
from fusionsupervision.property import BoolProp, IntegerProp, StringProp, ListProp, DictProp
...
class Contacts(CommandCallItems):
    ...
    def linkify(self, commands, notificationways):
        ...
        :type notificationways: fusionsupervision.objects.notificationway.Notificationways
        :return: None
