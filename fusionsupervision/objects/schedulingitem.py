...
from fusionsupervision.objects.commandcallitem import CommandCallItems
from fusionsupervision.dependencynode import DependencyNode

from fusionsupervision.action import ACT_STATUS_WAIT_CONSUME, ACT_STATUS_ZOMBIE, \
    ACT_STATUS_WAIT_DEPEND, ACT_STATUS_WAITING_ME, ACT_STATUS_POLLED
from fusionsupervision.check import Check
from fusionsupervision.property import (BoolProp, IntegerProp, FloatProp, SetProp,
                              CharProp, StringProp, ListProp, DictProp)
from fusionsupervision.util import to_serialized, from_serialized, dict_to_serialized_dict, \
...
from fusionsupervision.dependencynode import DependencyNodeFactory
from fusionsupervision.acknowledge import Acknowledge
...
class SchedulingItem(Item):  # pylint: disable=R0902
    ...
    properties.update({
        ...
        # FusionSupervision Engine specific
        'poller_tag':
    ...
    def update_flapping(self, notif_period, hosts, services):
        ...
        :type notif_period: fusionsupervision.object.timeperiod.Timeperiod
    ...
    def do_check_freshness(self, hosts, services, timeperiods, macromodulations, checkmodulations,
        ...
        This function is called by the scheduler if FusionSupervision Engine is configured to check the freshness.
        ...
        :type timeperiods: fusionsupervision.objects.timeperiod.Timeperiods
        :param macromodulations: Macro modulations objects, used in commands (notif, check)
        :type macromodulations: fusionsupervision.objects.macromodulation.Macromodulations
        :param checkmodulations: Checkmodulations objects, used to change check command if necessary
        :type checkmodulations: fusionsupervision.objects.checkmodulation.Checkmodulations
    ...
    def set_myself_as_problem(self, hosts, services, timeperiods, bi_modulations):
        ...
        :type bi_modulations: fusionsupervision.object.businessimpactmodulation.Businessimpactmodulations
        :return: None
        """
        now = time.time()
    ...
    def register_a_problem(self, prob, hosts, services, timeperiods, bi_modulations):
        ...
        :type prob: fusionsupervision.objects.schedulingitem.SchedulingItem
        ...
        :rtype: list[fusionsupervision.objects.schedulingitem.SchedulingItem]
        TODO: SchedulingItem object should not handle other schedulingitem obj.
              We should call obj.register* on both obj.
              This is 'Java' style
        """
    ...
    def raise_dependencies_check(self, ref_check, hosts, services, timeperiods, macromodulations,
        ...
        * dep.last_state_update < now - cls.cached_check_horizon (check of dependency is "old")
        ...
        :type ref_check: fusionsupervision.check.Check
    ...
    def disable_active_checks(self, checks):
        ...
        :type checks: fusionsupervision.objects.check.Checks
        :return: None
        """
    ...
    def remove_in_progress_check(self, check):
        ...
        :type check: fusionsupervision.objects.check.Check
        :return: None
        """
    ...
    def remove_in_progress_notification(self, notification):
        ...
        :type notification: fusionsupervision.notification.Notification
        :return: None
        """
    ...
    def consume_result(self, chk, notification_period, hosts,
        ...
        * is_volatile: notif immediately (service only)
        ...
        :type chk: fusionsupervision.objects.check.Check
        :param notification_period: notification period for this host/service
        :type notification_period: fusionsupervision.objects.timeperiod.Timeperiod
        :param hosts: hosts objects, used for almost every operation
        :type hosts: fusionsupervision.objects.host.Hosts
        :param services: services objects, used for almost every operation
        :type services: fusionsupervision.objects.service.Services
        ...
        :type res_modulations: fusionsupervision.object.resultmodulation.Resultmodulations
        :param checks: checks dict, used to get checks_in_progress for the object
        :type checks: dict
        :return: Dependent checks
        :rtype list[fusionsupervision.check.Check]
        """
    ...
    def prepare_notification_for_sending(self, notif, contact, macromodulations, timeperiods,
        ...
        :type notif: fusionsupervision.objects.notification.Notification
        ...
        :type host_ref: fusionsupervision.object.host.Host
        :return: None
        """
    ...
    def update_notification_command(self, notif, contact, macromodulations, timeperiods,
        ...
        :type contact: fusionsupervision.object.contact.Contact
        :param macromodulations: Macro modulations objects, used in the notification command
        :type macromodulations: fusionsupervision.objects.macromodulation.Macromodulations
        :param timeperiods: Timeperiods objects, used to get modulation period
        :type timeperiods: fusionsupervision.objects.timeperiod.Timeperiods
    ...
    def is_escalable(self, notification, escalations, timeperiods):
        ...
        :type notification: fusionsupervision.objects.notification.Notification
        :param escalations: Esclations objects, used to get escalation objects (period)
        :type escalations: fusionsupervision.objects.escalation.Escalations
    ...
    def scatter_notification(self, notif, contacts, notifways, timeperiods, macromodulations,
        ...
        :type contacts: fusionsupervision.objects.contact.Contacts
        :param notifways: Notificationway objects, used to get notific commands
        :type notifways: fusionsupervision.object.notificationway.Notificationways
        ...
        :rtype: list[fusionsupervision.objects.notification.Notification]
        """
        if notif.contact:
    ...
    def launch_check(self, timestamp, hosts, services, timeperiods,
        ...
        :param dependent:
        :type dependent: bool
        :return: None or fusionsupervision.check.Check
        :rtype: None | fusionsupervision.check.Check
        """
        chk = None
        cls = self.__class__
    ...
    def acknowledge_problem(self, notification_period, hosts, services, sticky, notify, author,
        ...
        :type end_time: int
        :return: None | fusionsupervision.comment.Comment
        """
        comm = None
    ...
    def raise_snapshot_log_entry(self, command):  # pragma: no cover, base function
        ...
        :type command: fusionsupervision.objects.command.Command
        :return: None
        """
        pass
    ...
    def manage_stalking(self, check):  # pragma: no cover, base function
        ...
        :type check: fusionsupervision.check.Check
        :return: None
        """
        pass
    ...
    def notification_is_blocked_by_contact(self, notifways, timeperiods, notif,
        ...
        :type notif: fusionsupervision.objects.contact.Contact
...
class SchedulingItems(CommandCallItems):
    ...
    def create_business_rules(self, hosts, services, hostgroups, servicegroups,
        ...
        :type hostgroups: fusionsupervision.objects.hostgroup.Hostgroups
        :param servicegroups: servicegroups to link to
        :type servicegroups: fusionsupervision.objects.servicegroup.Servicegroups
