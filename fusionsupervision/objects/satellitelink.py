...
"""
This module provides an abstraction layer for communications between FusionSupervision Engine daemons
Used by the Arbiter
"""
...
from fusionsupervision.util import get_obj_name_two_args_and_void
...
from fusionsupervision.property import BoolProp, IntegerProp, FloatProp
from fusionsupervision.property import StringProp, ListProp, DictProp, AddrProp
from fusionsupervision.http.client import HTTPClient, HTTPClientException, HTTPClientDataException
from fusionsupervision.http.client import HTTPClientConnectionException, HTTPClientTimeoutException
...
class SatelliteLink(Item):
    ...
    def get_a_satellite_link(sat_type, sat_dict):
        ...
        :return:
        """
        cls = get_fusionsupervision_class('fusionsupervision.objects.%slink.%sLink' % (sat_type, sat_type.capitalize()))
