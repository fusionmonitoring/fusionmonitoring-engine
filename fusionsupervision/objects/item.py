...
from fusionsupervision.property import (StringProp, ListProp, BoolProp, SetProp, DictProp,
                              IntegerProp, ToGuessProp, PythonizeError)

from fusionsupervision.fusionsupervisionobject import FusionsupervisionObject
from fusionsupervision.brok import Brok
from fusionsupervision.util import strip_and_uniq, is_complex_expr, dict_to_serialized_dict
from fusionsupervision.complexexpression import ComplexExpressionFactory
from fusionsupervision.graph import Graph

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name


class Item(FusionsupervisionObject):
    """Class to manage an item

    An Item is the base of many objects of FusionSupervision Engine. So it defines properties that are common
    to all the objects:
    - name
    ...
    common functions.
    """
    properties = FusionsupervisionObject.properties.copy()
    properties.update({
        'name':
    ...
    def __init__(self, params=None, parsing=True):
        ...
        super(Item, self).__init__(params, parsing)
        # The new FusionSupervision Engine object unique identifier is set by the base FusionsupervisionObject class...
        ...
        for key in params:
            ...
            if (isinstance(val, list) and
                ...
                # _dist prefixed variables are reserved for FusionSupervision Engine directories
    ...
    def load_global_conf(cls, global_configuration):
        """
        Apply global FusionSupervision Engine configuration.
...
class Items(object):
    ...
    def __getitem__(self, key):
        ...
        :rtype: fusionsupervision.object.item.Item
        """
    ...
    def add_items(self, items, index_items):
        ...
        :type items: fusionsupervision.objects.item.Items
    ...
    def manage_conflict(self, item, name):
        ...
        :type item: fusionsupervision.objects.item.Item
    ...
    def add_template(self, tpl):
        ...
        :type tpl: fusionsupervision.objects.item.Item
        :return: None
        """
    ...
    def find_by_name(self, name):
        ...
        :type name: str
        :return: item
        :rtype: fusionsupervision.objects.item.Item
        """
    ...
    def linkify_with_resultmodulations(self, resultmodulations):
        ...
        :type resultmodulations: fusionsupervision.resultmodulation.Resultmodulations
        :return: None
        """
        for i in self:
    ...
    def linkify_with_business_impact_modulations(self, business_impact_modulations):
        ...
        :type business_impact_modulations: fusionsupervision.objects.businessmodulation.Businessmodulations
        :return: None
        """
        for i in self:
    ...
    def explode_contact_groups_into_contacts(item, contactgroups):
        ...
        :type contactgroups: fusionsupervision.objects.contactgroup.Contactgroups
        :return: None
        """
    ...
    def linkify_s_by_module(self, modules):
        ...
        :type modules: fusionsupervision.objects.module.Modules
        :return: None
        """
        for i in self:
    ...
    def get_property_by_inheritance(self, obj, prop):
        ...
        :type obj: fusionsupervision.objects.item.Item
