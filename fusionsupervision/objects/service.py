...
from fusionsupervision.objects.schedulingitem import SchedulingItem, SchedulingItems

from fusionsupervision.autoslots import AutoSlots
from fusionsupervision.util import (
    strip_and_uniq,
    generate_key_value_sequences,
    is_complex_expr,
    KeyValueSyntaxError)
from fusionsupervision.property import BoolProp, IntegerProp, StringProp, ListProp, CharProp
...
######
    ...
    def get_hostgroups(self, hosts):
        ...
        :rtype: fusionsupervision.objects.hostgroup.Hostgroups
        """
    ...
    def get_host_tags(self, hosts):
        ...
        :rtype: fusionsupervision.objects.tag.Tags
        """
    ...
    def duplicate(self, host):
        ...
        :param host: fusionsupervision host object
...
####
    ...
    def notification_is_blocked_by_contact(self, notifways, timeperiods, notif, contact):
        ...
        :type notifways: fusionsupervision.objects.notificationway.NotificationWays
...
class Services(SchedulingItems):
    ...
    def find_srvs_by_hostname(self, host_name):
        ...
        :rtype: list[fusionsupervision.objects.service.Service]
        """
    ...
    def find_srv_by_name_and_hostname(self, host_name, sdescr):
        ...
        :rtype: fusionsupervision.objects.service.Service
        """
    ...
    def linkify(self, hosts, commands, timeperiods, contacts,  # pylint: disable=R0913
        ...
        :type commands: fusionsupervision.objects.command.Commands
        ...
        :type resultmodulations: fusionsupervision.objects.resultmodulation.Resultmodulations
        :param businessimpactmodulations: businessimpactmodulations to link
        :type businessimpactmodulations:
              fusionsupervision.objects.businessimpactmodulation.Businessimpactmodulations
    ...
    def explode_services_from_templates(self, hosts, service_template):
        ...
        :type service_template: fusionsupervision.objects.service.Service
        :return: None
        """
    ...
    def explode(self, hosts, hostgroups, contactgroups, servicegroups, servicedependencies):
        ...
        :param hosts: The hosts container
        :type hosts: [fusionsupervision.object.host.Host]
        :param hostgroups: The hosts goups container
        :type hostgroups: [fusionsupervision.object.hostgroup.Hostgroup]
        :param contactgroups: The contacts goups container
        :type contactgroups: [fusionsupervision.object.contactgroup.Contactgroup]
        :param servicegroups: The services goups container
        :type servicegroups: [fusionsupervision.object.servicegroup.Servicegroup]
        :param servicedependencies: The services dependencies container
        :type servicedependencies: [fusionsupervision.object.servicedependency.Servicedependency]
        :return: None
        """
