...
"""
import re
from fusionsupervision.util import filter_any, filter_none
from fusionsupervision.util import filter_host_by_name, filter_host_by_regex, filter_host_by_group,\
    filter_host_by_tag
from fusionsupervision.util import filter_service_by_name
from fusionsupervision.util import filter_service_by_regex_name
from fusionsupervision.util import filter_service_by_regex_host_name
from fusionsupervision.util import filter_service_by_host_name
from fusionsupervision.util import filter_service_by_bp_rule_label
from fusionsupervision.util import filter_service_by_hostgroup_name
from fusionsupervision.util import filter_service_by_host_tag_name
from fusionsupervision.util import filter_service_by_servicegroup_name
from fusionsupervision.util import filter_host_by_bp_rule_label
from fusionsupervision.util import filter_service_by_host_bp_rule_label
...
class DependencyNodeFactory(object):
    ...
    def eval_simple_cor_pattern(self, pattern, hosts, services,
        ...
        if re.search(r"^([%s]+|\*):" % self.host_flags, pattern) or \
            ...
            # here we have FusionSupervision Engine SchedulingItem object (Host/Service)
            if obj is not None:
                # Set host or service
